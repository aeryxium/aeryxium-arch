...
## AUR Packages
Some packages depend on AUR packages being available to `pacman`. This is best done by using a custom repository. AUR packages required by PKGBUILDs in this repo are listed below:
